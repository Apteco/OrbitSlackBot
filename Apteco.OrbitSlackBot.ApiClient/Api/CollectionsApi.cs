...
namespace Apteco.OrbitSlackBot.ApiClient.Api
{
    ...
    public interface ICollectionsApi : IApiAccessor
    {
        ...
        /// <returns>CollectionDetail</returns>
        CollectionDetail CollectionsTransferCollectionOwnership (string dataViewName, int? collectionId, string newUsername);
        ...
        /// <param name="newUsername"></param>
        /// <returns>ApiResponse of CollectionDetail</returns>
        ApiResponse<CollectionDetail> CollectionsTransferCollectionOwnershipWithHttpInfo (string dataViewName, int? collectionId, string newUsername);
        /// <summary>
        ...
        /// <param name="newUsername"></param>
        /// <returns>Task of CollectionDetail</returns>
        System.Threading.Tasks.Task<CollectionDetail> CollectionsTransferCollectionOwnershipAsync (string dataViewName, int? collectionId, string newUsername);
        ...
        /// <param name="newUsername"></param>
        /// <returns>Task of ApiResponse (CollectionDetail)</returns>
        System.Threading.Tasks.Task<ApiResponse<CollectionDetail>> CollectionsTransferCollectionOwnershipAsyncWithHttpInfo (string dataViewName, int? collectionId, string newUsername);
        /// <summary>
        /// Updates the details of a particular collection.  If you don&#39;t have an id for the  collection then POST to the /Collections URL to create a new collection.
        /// </summary>
        /// <remarks>
    ...
    public partial class CollectionsApi : ICollectionsApi
    {
        ...
        /// <param name="newUsername"></param>
        /// <returns>CollectionDetail</returns>
        public CollectionDetail CollectionsTransferCollectionOwnership (string dataViewName, int? collectionId, string newUsername)
        {
             ApiResponse<CollectionDetail> localVarResponse = CollectionsTransferCollectionOwnershipWithHttpInfo(dataViewName, collectionId, newUsername);
             return localVarResponse.Data;
        }
        ...
        /// <param name="newUsername"></param>
        /// <returns>ApiResponse of CollectionDetail</returns>
        public ApiResponse< CollectionDetail > CollectionsTransferCollectionOwnershipWithHttpInfo (string dataViewName, int? collectionId, string newUsername)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
            ...
            if (newUsername == null)
                throw new ApiException(400, "Missing required parameter 'newUsername' when calling CollectionsApi->CollectionsTransferCollectionOwnership");
            ...
            if (dataViewName != null) localVarPathParams.Add("dataViewName", Configuration.ApiClient.ParameterToString(dataViewName)); // path parameter
            if (collectionId != null) localVarPathParams.Add("collectionId", Configuration.ApiClient.ParameterToString(collectionId)); // path parameter
            if (newUsername != null) localVarFormParams.Add("NewUsername", Configuration.ApiClient.ParameterToString(newUsername)); // form parameter
        ...
        /// <param name="newUsername"></param>
        /// <returns>Task of CollectionDetail</returns>
        public async System.Threading.Tasks.Task<CollectionDetail> CollectionsTransferCollectionOwnershipAsync (string dataViewName, int? collectionId, string newUsername)
        {
             ApiResponse<CollectionDetail> localVarResponse = await CollectionsTransferCollectionOwnershipAsyncWithHttpInfo(dataViewName, collectionId, newUsername);
             return localVarResponse.Data;
        ...
        /// <param name="newUsername"></param>
        /// <returns>Task of ApiResponse (CollectionDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CollectionDetail>> CollectionsTransferCollectionOwnershipAsyncWithHttpInfo (string dataViewName, int? collectionId, string newUsername)
        {
            // verify the required parameter 'dataViewName' is set
            if (dataViewName == null)
                throw new ApiException(400, "Missing required parameter 'dataViewName' when calling CollectionsApi->CollectionsTransferCollectionOwnership");
