...
namespace Apteco.OrbitSlackBot.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CollectionSummary :  IEquatable<CollectionSummary>, IValidatableObject
    {
        /// <summary>
        ...
        public CollectionSummary(int? Id = default(int?), string Title = default(string), string Description = default(string), DateTime? CreationDate = default(DateTime?), UserDisplayDetails Owner = default(UserDisplayDetails), DateTime? DeletionDate = default(DateTime?), int? NumberOfParts = default(int?), int? NumberOfUsersSharedWith = default(int?), int? CollectionShareId = default(int?), int? NumberOfHits = default(int?))
        {
            ...
            {
                throw new InvalidDataException("CollectionShareId is a required property for CollectionSummary and cannot be null");
            }
            else
            {
