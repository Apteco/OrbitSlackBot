...
namespace Apteco.OrbitSlackBot.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserCollectionDetail :  IEquatable<UserCollectionDetail>, IValidatableObject
    {
        /// <summary>
        ...
        public UserCollectionDetail(string ViewingUsername = default(string), StatusEnum Status = default(StatusEnum), bool? SharedToMe = default(bool?), bool? SharedByMe = default(bool?), int? Id = default(int?), UserDisplayDetails Owner = default(UserDisplayDetails), int? NumberOfParts = default(int?), int? NumberOfUsersSharedWith = default(int?), int? CollectionShareId = default(int?), int? NumberOfHits = default(int?), string Title = default(string), string Description = default(string), DateTime? CreationDate = default(DateTime?), string FilePath = default(string), DateTime? DeletionDate = default(DateTime?))
        {
            ...
            {
                throw new InvalidDataException("CollectionShareId is a required property for UserCollectionDetail and cannot be null");
            }
            else
            {
